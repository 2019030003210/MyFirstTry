...
public final class givenlocation_005fresult_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    }\n");
      out.write("\n");
      out.write("    var use_num = change('");
      out.print(request.getAttribute("use_num") );
      out.write("');\n");
      out.write("    var given_location = change('");
      out.print(request.getAttribute("given_location") );
      out.write("');\n");
      ...
      out.write("        xAxis: {data: given_location},\n");
      out.write("        yAxis: {},\n");
      out.write("        series: [{name: '使用时间', type: 'bar', data: use_num, barWidth: 30}]\n");
      out.write("    });\n");
      out.write("</script>\n");
