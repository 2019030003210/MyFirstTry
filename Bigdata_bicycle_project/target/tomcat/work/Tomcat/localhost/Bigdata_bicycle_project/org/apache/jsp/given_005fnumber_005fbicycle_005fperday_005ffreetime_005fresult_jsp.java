...
public final class given_005fnumber_005fbicycle_005fperday_005ffreetime_005fresult_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    }\n");
      out.write("\n");
      out.write("    var free_time = change('");
      out.print(request.getAttribute("free_time") );
      out.write("');\n");
      out.write("    var given_number_bicycle = change('");
      out.print(request.getAttribute("given_number_bicycle") );
      out.write("');\n");
      out.write("    //初始化，默认显示标题，图例和xy空坐标轴\n");
      out.write("    myChart.setOption({\n");
      out.write("        title: {text: '统计共享单车指定车辆每次使用的空闲平均时间'},\n");
      out.write("        tooltip: {},\n");
      out.write("        legend: {data: ['每天使用总时间(小时)'], show: true},\n");
      out.write("        xAxis: {data: given_number_bicycle},\n");
      out.write("        yAxis: {},\n");
      out.write("        series: [{name: '空闲平均时间', type: 'bar', data: free_time, barWidth: 30}]\n");
      out.write("    });\n");
      out.write("</script>\n");
